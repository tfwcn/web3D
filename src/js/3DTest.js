...
function RotationViewMatrix(rotation)
{
    ...
    //rotWorldMatrix.makeRotationAxis(axis.normalize(), Math.PI/180*updownRotation);
    //rotWorldMatrix.makeRotationAxis(axis2.normalize(), Math.PI/180*leftrightRotation);
    //rotWorldMatrix.multiply(camera.matrix);                // pre-multiply
    //camera.rotation.setFromRotationMatrix(rotWorldMatrix);
    var quaternion = new THREE.Quaternion();
    quaternion.setFromAxisAngle( axis2.normalize(), Math.PI/180*30);
